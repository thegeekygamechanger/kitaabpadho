...
<head>
    ...
    <title>EduSwap Edit Stationery</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Add Stationery</h4>
...
<a href="change-bookimg.php?bookid=<?php echo htmlentities($result->bookid);?>">Change Stationery Image</a>
</div></div>

<div class="col-md-6">
<div class="form-group">
<label>Stationery Name<span style="color:red;">*</span></label>
...
<p class="help-block">Product ID, It must be Unique for Stationery</p>
</div></div>

...
$_SESSION['msg']="Stationery Returned successfully";
...
<head>
    ...
    <title>EduSwap Rented details</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Rrented Stationery Details</h4>
...
<div class="col-md-6"> 
<div class="form-group">
<label>Stationery rent Date :</label>
<?php echo htmlentities($result->IssuesDate);?>
</div></div>

<div class="col-md-6"> 
<div class="form-group">
<label>Stationery Returned Date :</label>
...
<button type="submit" name="return" id="submit" class="btn btn-info">Return Stationery </button>

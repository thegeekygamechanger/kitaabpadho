...
<head>
    ...
    <title>EduSwap Rental stationery</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Rent a Stationery</h4>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Rent Stationery </button>
